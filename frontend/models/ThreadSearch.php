...
/**
 * ThreadSearch represents the model behind the search form of `frontend\models\Thread`.
 */
class ThreadSearch extends Thread
{
     ...
     */
    public function search($params, $topicId)
    {
        $query = Thread::find()->where(['=', 'topicId', $topicId]);
